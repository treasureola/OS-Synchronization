...
extern int sys_lockcreate(void);
extern int sys_locktake(void);
extern int sys_lockrelease(void);
extern int sys_lockdelete(void);
...
static int (*syscalls[])(void) = {
  ...
  [SYS_close] sys_close, [SYS_lockcreate]sys_lockcreate,  [SYS_locktake] sys_locktake,     [SYS_lockrelease]sys_lockrelease,
  [SYS_lockdelete]sys_lockdelete,
};
